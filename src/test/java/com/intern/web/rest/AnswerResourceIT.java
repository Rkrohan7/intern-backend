...
class AnswerResourceIT {
    ...
    private static final Boolean DEFAULT_CORRECT_ANS = false;
    private static final Boolean UPDATED_CORRECT_ANS = true;
    ...
    public static Answer createEntity(EntityManager em) {
        Answer answer = new Answer().answer(DEFAULT_ANSWER).correctAns(DEFAULT_CORRECT_ANS).questionId(DEFAULT_QUESTION_ID);
        return answer;
    }
    ...
    public static Answer createUpdatedEntity(EntityManager em) {
        Answer answer = new Answer().answer(UPDATED_ANSWER).correctAns(UPDATED_CORRECT_ANS).questionId(UPDATED_QUESTION_ID);
        return answer;
    }
    ...
    void createAnswer() throws Exception {
        ...
        assertThat(testAnswer.getCorrectAns()).isEqualTo(DEFAULT_CORRECT_ANS);
    ...
    void getAllAnswers() throws Exception {
        ...
        restAnswerMockMvc
            ...
            .andExpect(jsonPath("$.[*].correctAns").value(hasItem(DEFAULT_CORRECT_ANS.booleanValue())))
    ...
    void getAnswer() throws Exception {
        ...
        restAnswerMockMvc
            ...
            .andExpect(jsonPath("$.correctAns").value(DEFAULT_CORRECT_ANS.booleanValue()))
    ...
    void putExistingAnswer() throws Exception {
        ...
        updatedAnswer.answer(UPDATED_ANSWER).correctAns(UPDATED_CORRECT_ANS).questionId(UPDATED_QUESTION_ID);
        ...
        assertThat(testAnswer.getCorrectAns()).isEqualTo(UPDATED_CORRECT_ANS);
    ...
    void partialUpdateAnswerWithPatch() throws Exception {
        ...
        partialUpdatedAnswer.answer(UPDATED_ANSWER).correctAns(UPDATED_CORRECT_ANS);
    ...
    void fullUpdateAnswerWithPatch() throws Exception {
        ...
        partialUpdatedAnswer.answer(UPDATED_ANSWER).correctAns(UPDATED_CORRECT_ANS).questionId(UPDATED_QUESTION_ID);
