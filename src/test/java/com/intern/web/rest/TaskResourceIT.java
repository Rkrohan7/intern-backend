...
import com.intern.repository.TaskRepository;
import com.intern.service.dto.TaskDTO;
import com.intern.service.mapper.TaskMapper;
...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().taskName(DEFAULT_TASK_NAME);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().taskName(UPDATED_TASK_NAME);
        return task;
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.taskName(UPDATED_TASK_NAME);
